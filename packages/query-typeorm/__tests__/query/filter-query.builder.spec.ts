    ...
    it('with deeply nested and / or', () => {
      ...
      expect(qb.getReferencedRelationsWithAliasRecursive(qb.repo.metadata, complexQuery)).toEqual({
        oneTestRelation: {
          ...
          metadata: {
            inverseEntityMetadataTableName: 'test_relation',
            inverseRelationJoinColumnDatabaseName: undefined,
            joinTableName: undefined,
            junctionEntityMetadataInverseColumnDatabaseName: undefined,
            junctionEntityMetadataOwnerColumnDatabaseName: undefined,
          ...
          relations: {
            manyTestEntities: {
              ...
              metadata: {
                inverseEntityMetadataTableName: 'test_entity',
                inverseRelationJoinColumnDatabaseName: 'testEntityTestEntityPk',
                joinTableName: undefined,
                junctionEntityMetadataInverseColumnDatabaseName: 'testRelationTestRelationPk',
                junctionEntityMetadataOwnerColumnDatabaseName: 'testEntityTestEntityPk',
            ...
            relationOfTestRelation: {
              ...
              metadata: {
                inverseEntityMetadataTableName: 'relation_of_test_relation_entity',
                inverseRelationJoinColumnDatabaseName: undefined,
                joinTableName: undefined,
                junctionEntityMetadataInverseColumnDatabaseName: undefined,
                junctionEntityMetadataOwnerColumnDatabaseName: undefined,
    ...
    it('with nested and / or', () => {
      ...
      expect(qb.getReferencedRelationsWithAliasRecursive(qb.repo.metadata, query)).toEqual({
        testRelations: {
          ...
          metadata: {
            inverseEntityMetadataTableName: 'test_relation',
            inverseRelationJoinColumnDatabaseName: 'test_entity_id',
            joinTableName: undefined,
            junctionEntityMetadataInverseColumnDatabaseName: undefined,
            junctionEntityMetadataOwnerColumnDatabaseName: undefined,
        ...
        oneTestRelation: {
          ...
          relations: {
            relationsOfTestRelation: {
              ...
              metadata: {
                inverseEntityMetadataTableName: 'relation_of_test_relation_entity',
                inverseRelationJoinColumnDatabaseName: 'test_relation_id',
                joinTableName: undefined,
                junctionEntityMetadataInverseColumnDatabaseName: undefined,
                junctionEntityMetadataOwnerColumnDatabaseName: undefined,
                relationType: 'one-to-many'
