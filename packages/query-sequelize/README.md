...
[![npm version](https://img.shields.io/npm/v/@codeshine/nestjs-query-sequelize.svg)](https://www.npmjs.org/package/@codeshine/nestjs-query-sequelize)
...
The `query-sequelize` package that provides an implementation of `@codeshine/nestjs-query-core` `QueryService`, built on
...
The get started with the `@codeshine/nestjs-query-sequelize` package checkout
